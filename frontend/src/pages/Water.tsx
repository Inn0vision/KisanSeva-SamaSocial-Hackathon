  ...
  return (
    <div className="min-h-screen max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <motion.div 
        ...
        className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500 to-cyan-400 dark:from-blue-900 dark:to-cyan-900 text-white p-8 md:p-12 mb-12 shadow-2xl shadow-blue-500/20 dark:shadow-blue-900/20"
      >
        ...
        <div className="relative z-10 max-w-3xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/30 border border-blue-400/30 text-blue-200 text-sm font-semibold mb-6">
            <Activity size={16} /> {t('Live Water Intelligence')}
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 leading-tight">
            {t('Water Scarcity & Irrigation Intelligence')}
          </h1>
          <p className="text-lg md:text-xl text-blue-100/80 leading-relaxed max-w-2xl">
            {t('Understand your local water table, discover precision irrigation techniques, and adapt to changing climate conditions with data-driven insights.')}
          </p>
        </div>
      </motion.div>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="card-base p-6 border-t-4 border-t-blue-500 relative overflow-hidden">
            ...
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
              <MapPin className="text-blue-500" /> {t('Local Insights')}
            </h2>
            
            <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4 mb-6 border border-gray-100 dark:border-gray-700">
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{t('Current Region')}</p>
            ...
            <div className="space-y-3">
              <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">{t('Quick Local Search')}</p>
              ...
              >
                <span className="text-sm font-medium text-gray-700 dark:text-gray-200 group-hover:text-blue-600 dark:group-hover:text-blue-400">{t('Groundwater Levels')}</span>
              ...
              <a 
                ...
                className="flex items-center justify-between w-full p-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-500 transition-all group shadow-sm hover:shadow-md"
              >
                <span className="text-sm font-medium text-gray-700 dark:text-gray-200 group-hover:text-blue-600 dark:group-hover:text-blue-400">{t('Water Testing Labs')}</span>
                <Search size={14} className="text-gray-400 group-hover:text-blue-500" />
              </a>
              ...
              <a 
                ...
                className="flex items-center justify-between w-full p-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-500 transition-all group shadow-sm hover:shadow-md"
              >
                <span className="text-sm font-medium text-gray-700 dark:text-gray-200 group-hover:text-blue-600 dark:group-hover:text-blue-400">{t('Irrigation Experts')}</span>
                <Search size={14} className="text-gray-400 group-hover:text-blue-500" />
              </a>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="card-base p-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/10 dark:to-orange-900/10 border-amber-200 dark:border-amber-900/30">
            <h3 className="text-amber-800 dark:text-amber-500 font-bold flex items-center gap-2 mb-2">
              <ThermometerSun size={20} /> {t('Scarcity Alert')}
            </h3>
            <p className="text-amber-700/80 dark:text-amber-600/80 text-sm leading-relaxed mb-4">
              {t('Changing climate patterns require proactive water management. Traditional flood irrigation wastes up to 60% of water through evaporation and deep percolation.')}
            </p>
            <a 
            ...
            >
              {t('Read Climate Reports')} <ExternalLink size={14} />
            </a>
          </motion.div>
        </motion.div>
        ...
        >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
                  {t('Micro-Irrigation Transition')}
                </h2>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                  {t('Transitioning from traditional flood irrigation to drip or sprinkler systems can reduce water usage by up to 50% while simultaneously increasing crop yields. These systems deliver water directly to the root zone, significantly minimizing evaporation.')}
                </p>
                <a 
                ...
                >
                  {t('Learn implementation steps')} <ExternalLink size={16} />
                </a>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="card-base p-8 hover:shadow-lg transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
                  {t('Farm Ponds & Rainwater Harvesting')}
                </h2>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                  {t('Capturing rainwater during monsoons in lined farm ponds provides a critical lifeline during dry spells. When combined with groundwater recharge structures, it helps replenish the local water table, ensuring long-term sustainability.')}
                </p>
                <a 
          ...
          <motion.div variants={itemVariants} className="card-base p-8 hover:shadow-lg transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                  {t('Water management isn\'t just about irrigation; it\'s about retention. Practices like mulching, planting cover crops, and maintaining healthy soil organic matter can dramatically increase the soil\'s water-holding capacity, creating a natural reservoir.')}
                </p>
                <a 
