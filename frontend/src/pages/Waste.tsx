...
import { 
  ...
  Leaf, Sprout, Sun, Cloud, Cpu, ExternalLink
} from 'lucide-react'
...
export default function Waste() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-600 dark:bg-slate-950 dark:text-slate-300 font-sans -m-4 sm:-m-6 lg:-m-8 p-4 sm:p-6 lg:p-8">
      
      {/* Hero Section */}
      <div className="relative overflow-hidden pt-20 pb-16 px-6 lg:px-8 rounded-3xl bg-gradient-to-br from-teal-50 to-blue-50 dark:from-[#0a192f] dark:to-[#0a192f] dark:bg-[#0a192f] shadow-2xl shadow-blue-900/10 dark:shadow-blue-900/20 mb-16 border border-teal-100 dark:border-blue-900/30">
        ...
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-6">
            {t('Water Recycling &')} <br className="hidden md:block" />
          ...
          <p className="mt-4 text-lg md:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
            {t('Discover 10 comprehensive strategies to optimize, recycle, and manage water resources for a sustainable farming future.')}
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative flex items-start gap-12">
        ...
        <div className="hidden lg:block sticky top-24 w-72 shrink-0">
          <h3 className="text-xs font-bold uppercase tracking-widest text-teal-600 dark:text-teal-500 mb-6">{t('Navigating Concepts')}</h3>
        ...
        <div className="flex-1 w-full space-y-24">
          {waterConcepts.map((concept, index) => (
            ...
            >
              <div className={`relative p-8 md:p-10 rounded-3xl bg-white/80 dark:bg-[#0f172a]/80 backdrop-blur-sm border border-slate-200 dark:border-slate-800 ${concept.border} transition-colors duration-500 overflow-hidden shadow-xl shadow-black/5 dark:shadow-black/20`}>
                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start">
                  <div className={`p-5 rounded-2xl ${concept.bg} border border-slate-200 dark:border-slate-700/50 shrink-0 shadow-inner`}>
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-lg mt-4 max-w-2xl">
                    ...
                    <a 
                      ...
                      className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 transition-colors"
                    >
                      {t('See more')} <ExternalLink size={16} />
                    </a>
                  </div>
                </div>
              </div>
