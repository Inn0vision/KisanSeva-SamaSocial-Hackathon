        ...
        <div className="relative z-20 flex flex-col justify-center h-full p-16 text-white">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
            ...
            <p className="text-lg text-white/90 max-w-md leading-relaxed">
              Empower your agricultural journey with AI-driven crop diagnosis, hyper-local weather updates, and personalized scheme recommendations.
            </p>
          </motion.div>
        </div>
      </div>
        ...
        >
          <div className="mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Enter your details to get started with KisanSeva.
            </p>
          </div>
